                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Chào mừng quản lý của tôi !</h1>
                                </div>
                                ...
                                <form class="user" method="post" action="{{route('admin.checkLogin')}}">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group ">
                                            <input type="password" class="form-control form-control-user col-md-10"
                                                   id="passWordAdmin" placeholder="Mật khẩu..." name="password">
                                            <span class="form-control form-control-user col-md-2 btn btn-secondary" id="showHidenPassword">
                                                <i class="fas fa-eye-slash text-center" id="icon-eye"></i>
                                            </span>
                                        </div>
                                        @error('password')
                                        <p class="text-danger">{{ $message }}</p>
